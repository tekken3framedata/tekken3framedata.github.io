...
- [ ] Jack-2: Gigaton Punch -rivien hits per move ei ole täysin oikein. Command Full sisältää wind-up-suuntasekvenssin + napin (esim. `ccw,db,d,1`), mutta step 8c käsittelee sen yhtenä painalluksena. Oikea tulos olisi "0 1" (wind-up 0, isku 1). Vaatisi step 8c:n logiikan muutoksen (rivi 89-90: pure dir + bare button), mutta se vaikuttaisi myös muihin liikkeisiin (DF,2, f,N,4, qcb,1 jne.).
